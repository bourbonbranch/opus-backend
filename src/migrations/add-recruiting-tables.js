...
async function createRecruitingTables() {
    try {
    ...
    `);
        ...
        // Create default pipeline stages (director_id NULL = global defaults)
        await pool.query(`
    ...
    `);
        ...
        console.log('\n🎉 All Recruiting Module tables created successfully!');
        console.log('\nTables created:');
        ...
        console.error('❌ Error creating recruiting tables:', err);
        throw err;
    } finally {
        await pool.end();
    }
